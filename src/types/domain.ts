...
export type RowInput = {
  sourceRowId: string; businessName?: string; decisionMaker?: string; email?: string; renewalDate?: string; daysToRenew?: number | null; industry?: string; offerType?: string; notes?: string;
};
