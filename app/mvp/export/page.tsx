            ...
            <div key={opt.id} className={`bg-white rounded-2xl border shadow-sm p-5 flex items-start gap-4 hover:shadow-md transition-shadow ${done ? "border-emerald-200" : "border-slate-100"}`}>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  {!done ? (
                    <button onClick={() => setExported((p) => new Set([...p, opt.id]))} className="inline-flex items-center gap-1.5 rounded-lg bg-indigo-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-indigo-700 transition-colors">
